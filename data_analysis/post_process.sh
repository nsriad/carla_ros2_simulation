...
python3 visualization/generate_cam_gif.py "$DATASET_NAME"

echo "[2/3] Generating LiDAR Animation..."
python3 visualization/lidar_animator.py "$DATASET_NAME"

# echo "[3/3] Running LiDAR Visualizer..."
# python3 visualization/lidar_visualizer.py "$DATASET_NAME"

# echo "[4/4] Running Headway Analysis..."
# python3 visualization/headway_analysis.py "$DATASET_NAME"
